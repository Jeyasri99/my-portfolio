...
const Achievements = () => {
  return (
    ...
    //   >
    //     Public
    //     <span className="text-blue-700 font-medium">ations</span>
    //   </motion.h1>
      ...
      >
        {achievementsData.map((achievement, index) => (
          <motion.div
            ...
            className="bg-gradient-to-r from-blue-950 via-black to-black p-6 rounded-lg shadow-lg transform transition-transform duration-300"
          >
            <h2 className="text-xl font-bold mb-2">{achievement.title}</h2>
            <p className="text-lg mb-2">{achievement.description}</p>
          </motion.div>
